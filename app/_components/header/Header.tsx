...
import { HeaderSearchProvider, SearchButton } from "./HeaderSearch";
import { MobileNav } from "./MobileNav";
import { NavMenu } from "./NavMenu";

export function Header() {
  return (
    // `relative` so mega panels + the search panel anchor here and span the
    // full viewport width
